...
def main():
    ...
    parser.add_argument('--data-path', type=str, default='/media/hdd/mimic-cxr-eye/master_sheet.csv', help='Data path')
    parser.add_argument('--image-path', type=str,
                        default='/media/hdd/mimic-cxr-jpg/', help='image_path')
    parser.add_argument('--heatmaps-path', type=str, help='Heatmaps directory',
                        default='/media/hdd/mimic-cxr-eye/fixation-heatmaps')
    parser.add_argument('--split', choices=['test', 'train', 'val'], help='Split of dataset to use',
                        default='test')
    ...
    train_dl, valid_dl, test_dl = load_data(args.model_type, args.data_path, args.image_path, args.heatmaps_path,
                                            ...
                                            train_idx_path=args.data_idx_path, test_idx_path=args.data_idx_path)
